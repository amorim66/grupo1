...
import com.fatec.group1.repository.ItemDePedidoRepository;
import com.fatec.group1.model.Pedido;
import com.fatec.group1.repository.PedidoRepository;
import com.fatec.group1.repository.ProdutoRepository;
...
public class MantemPedidoI implements MantemPedido {
	...
	public Pedido save(Pedido pedido) {
		...
		for (ItemDePedido item : pedido.getItens()) {
			item.setProduto(produtoRepository.getReferenceById(item.getProduto().getId()));
